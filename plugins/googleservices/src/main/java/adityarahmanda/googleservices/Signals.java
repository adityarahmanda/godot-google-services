...
public class Signals {
    ...
    public static final String SIGNAL_ADMOB_REWARDED_FAILED_SHOW_FULLSCREEN_CONTENT = "admob_rewarded_failed_show_fullscreen_content";
    public static final String SIGNAL_ADMOB_REWARDED_IMPRESSION = "admob_rewarded_impression";
